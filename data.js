...
const FL_HOUSES = [
  ...
  },*/
  {
    id: 'fl2',
    dest: 'fl',
    name: 'Royal Seas + Sea La Vie',
    house1: { beds: 7, fullBaths: 7, halfBaths: 1 },
    house2: { beds: 5, fullBaths: 5, halfBaths: 1 },
    ...
    caveat: 'Royal Seas pool heat is extra ($400/wk); elevator also has a $100 fee. Sea La Vie is across the street from beach, not beachfront, and has no elevator.',
    ...
    photoB:  'https://photos.barefoot.com/v3ccln0929/images/properties/27856/1+-+Exterior-Front+Elevation-_PID0012.JPG?v=62339',
    labelA: 'Royal Seas',
    labelB: 'Sea La Vie',
  ...
  },*/
  {
    ...
    cost:  '$20,770',
    extras: [
      'Casa Bella Luca — the "Cartel house" - has been heavily renovated',
    ...
    caveat: 'Pool heat extra ($400/wk) and elevator has a $100 fee at both houses. AB Sea spa has been removed. AB Sea is beach access, not beachfront.',
    photoA:  'https://photos.barefoot.com/v3ccln0929/images/properties/52600/%232.jpg?v=93103',
    photoB:  'https://photos.barefoot.com/v3ccln0929/images/properties/46130/1+-+A-B-Sea-Exterior.jpg?v=77087',
    labelA: 'Casa Bella Luca',
    labelB: 'AB Sea',
...
const MI_HOUSES = [
  // mi1 — "Good"
  {
    ...
    caveat: 'Neither house is directly on the beach — 3 min walk to lake access. Harbor Breeze pool is community/shared, not private. Houses are 0.5 mile apart.',
  ...
  // mi3 — "Extra Luxury"
  {
    ...
    caveat: 'Significant quality gap between houses — the estate is exceptional but the cottage is modest. Best amenities, most uneven split. No pool at cottage.',
